...
def exercise_1_dag():
    ...
    @task
    def square_favorite_number(my_favorite_number):
        squared_favorite_number = my_favorite_number**2
        print(f"Squared favorite number: {squared_favorite_number}")
        return squared_favorite_number

    _square_favorite_number = square_favorite_number(_fetch_favorite_number)

    chain(_fetch_favorite_number, _square_favorite_number)

    chain(
        _fetch_favorite_number,
        _modify_favorite_number,
        _print_modified_favorite_number,
        _square_favorite_number,
    )
